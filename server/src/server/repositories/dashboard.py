...
class DashboardRepository:
    ...
    def get_column_proportion(
        self, column: str, start_date: datetime, end_date: datetime
    ):
        stmt = (
    ...
    # ---------- Categorical field ----------
    def get_categorical_distribution(self, field: str):
