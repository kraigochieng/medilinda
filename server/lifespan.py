...
from .ml.datasets import ADR_CSV_PATH, MEDICAL_INSTITUTIONS_CSV_PATH, USERS_CSV_PATH
...
from .models.adverse_drug_reaction_report import ADRModel
from .models.causality_assessment_level import (
    CausalityAssessmentLevelEnum,
    CausalityAssessmentLevelModel,
)
from .models.medical_institution import (
    MedicalInstitutionModel,
    MedicalInstitutionTelephoneModel,
)
from .models.review import ReviewModel
from .models.sms import SMSMessageModel, SMSMessageTypeEnum
...
async def lifespan(app: FastAPI):
    ...
    required_dirs = {"encoders", "model", "scalers", "metadata"}
    ...
    # ml_model = get_ml_model(ML_MODEL_PATH)
    logging.info("Storing ML Model...")
    app.state.ml_model = joblib.load(ML_MODEL_PATH)
    ml_model: BaseEstimator = app.state.ml_model
    logging.info("Stored ML Model...")
