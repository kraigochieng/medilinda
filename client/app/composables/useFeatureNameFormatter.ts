...
// 	}
// }
export const useFeatureNameFormatter = (name: string): string => {
	if (!name) return "Unknown";

	// Handle special cases
	if (name === "patient_weight_kg") return "Patient Weight (kg)";
	if (name === "patient_height_cm") return "Patient Height (cm)";
