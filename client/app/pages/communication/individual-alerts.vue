...
import {
	fetchAlreadySentIndividualAlerts,
	fetchToBeSentIndividualAlerts,
} from "@/api/sms";
...
// --- Computed properties to drive the UI dynamically ---

// --- Table Column Definitions (using accessorKey & header) ---

// Adr_id	Patient_name	Medical_institution_mfl_code	Medical_institution_name	Created_at	Telephones	Sms_count
